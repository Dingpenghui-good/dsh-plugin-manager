...
### Changed
- 适配 DSH `0.1.6-alpha.1`：全部 `@deepseek-ai/dsh-*` peer 依赖从 `^0.1.5-rc.1` 升级至 `^0.1.6-alpha.1`（预发布 semver 规则下旧区间永远无法解析到 0.1.6-alpha.1）
- 重新构建 host + client bundle，与 0.1.6-alpha.1 基座模块表对齐
